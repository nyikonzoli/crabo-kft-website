...
@section('content')
    ...
    <div class="modal" id="modifyModal" tabindex="-1">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                {{ Form::label('type', 'Kérem adja meg a() új nevét', ["class" => "form-label", "id" => "modifyModalText"]) }}
...
@section('script')
    <script>
        ...
        function updateGearbox(url, type){
            ...
            document.getElementById('modifyModalText').innerHTML = "Biztosan törölni szeretné a(z) " + type + " sebességváltó típust?";
